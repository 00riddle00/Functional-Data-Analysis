...
response shape, with female subjects exhibiting systematically lower amplitudes in the post-stimulus
window.
\end{abstract}
...
The complete source code used for this project, including the R and Python
implementations, data preprocessing scripts, statistical analyses, and LaTeX
report source files, is publicly available at:
...
Some FDA procedures were implemented primarily in R due to the greater maturity
of FDA-related libraries in the R ecosystem.
